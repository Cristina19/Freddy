...
namespace Freddy
{
    ...
    {
        int timp=15,intreb,s=20,nr,pr,i,j=1,k=0,q=0;
        int[] nrintr = new int[4];
        int[] intr = new int[4];
        int[] v = new int[61];
        int[] cor = new int[61];
        Image img1 = Properties.Resources.corect;
        Image img2 = Properties.Resources.delete1;
        SoundPlayer player1;
        String preg;
        bool sw = false;
        ...
        public Form7()
        {
            ...
            init();
                player1 = new SoundPlayer(Properties.Resources.inceput);
                player1.Play();
        }
        void inlocuire()
        {
        ...
        void aleator()
        {
            ...
            if(nr<=20)
            {
                ...
                label3.Text = "Hmmm...Oare această afirmație este adevărată sau falsă?";
                    player1 = new SoundPlayer(Properties.Resources.gandeste);
                    player1.Play();
                timer1.Start();
            }
            else
            {
                if (sw == false)
                {
                        player1 = new SoundPlayer(Properties.Resources.final);
                        player1.Play();
                    pr = s * 100 / 20;
                    inlocuire();
                    timer3.Stop();
                    ...
                    pictureBox2.Image = Properties.Resources.sare;
                }
                else
                {
                    q++;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                player1 = new SoundPlayer(Properties.Resources.gresit);
                player1.Play();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                pictureBox4.Image = img1;
                pictureBox4.Visible = true;
                player1 = new SoundPlayer(Properties.Resources.corect1);
                player1.Play();
            }
            button3.Enabled = false;
            button2.Enabled = false;
